...
public:
    int maxArea(int h, int w, vector<int>& horizontalCuts, vector<int>& verticalCuts) 
    {
        ...
        int maxiwidth=max(horizontalCuts[0]-0, h- horizontalCuts[horizontalCuts.size()-1]); //important
        ...
        int maxiheight=max(verticalCuts[0]-0, w-verticalCuts[verticalCuts.size()-1]); //important
